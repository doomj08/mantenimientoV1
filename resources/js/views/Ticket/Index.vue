                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700" v-for="(ticket,index) in tickets" :key="index">
                            ...
                            <td class="p-4 space-x-2 whitespace-nowrap">
                                ...
                                <DeleteForm  @update="getTickets()" :name="ticket.nombre" url="tickets" :id="ticket.id" v-if="(!ticket['estado-ticket']>0)"/>
                                <router-link  :to="{ name: 'ticket_pdf', params: { ticket_id:ticket.id }}">Ver PDF</router-link>
