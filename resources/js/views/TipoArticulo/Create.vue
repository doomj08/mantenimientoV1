...
const save=()=>{
    ...
    sendRequestWithFiles('POST',form.value,'/api/tipo_articulos');
    
}

</script>
<template>
    <button @click="showModal" type="button" data-modal-toggle="add-user-modal" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700">
    ...
    <Modal :size="size" v-if="isShowModal" @close="closeModal">
      ...
      <template #body>
        <Input size="sm" v-model="form.tipo" label="Nombre interno" :validationStatus="(form.errors.tipo?'error':'')">
