<template>
    ...
    <div class="flex flex-col" v-for="(servicio, index) in servicios" :key="index">
                     ...
                     class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            <tr>
                                ...
                                <td>
                                    <kbd v-for="(servicio,index) in servicios" :key="index" class="inline-flex m-1 items-center px-2 py-1.5 text-gray-800 bg-green-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-100 dark:border-gray-500">
            ...
            <div class="overflow-hidden shadow">
                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700" v-for="(servicio,index) in servicios" :key="index">
                            ...
                            <td class=" items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                    <div class="text-base font-semibold text-gray-900 dark:text-white">{{ servicio.precio }}</div>
                                </div>
                            </td>

                          
                            <td class="p-4 space-x-2 whitespace-nowrap">
                                <EditForm @update="getActividades()" class="text-left" :id="servicio.id"/>

                                <DeleteForm @update="getActividades()" :name="servicio.id" :url="'tickets/'+props.ticket_id+'/actividad_ticket'" :id="servicio.id"/>
                            </td>
                        </tr>
...
<script setup>
    ...
    const getActividades=async () =>{
        let res;
            ...
            await axios(
            {
                method:'GET', url:'api/tickets/'+props.ticket_id+'/servicio/', data:null,headers:config.headers
            }
        )
        .then(
            (response) => {
