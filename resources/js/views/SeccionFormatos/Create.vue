...
const save=()=>{
    ...
    sendRequestWithFiles('POST',form.value,'api/formatos/'+props.formato_id+'/seccion_formato');
}
...
<template>
    ...
    <Modal :size="size" v-if="isShowModal" @close="closeModal">
      ...
      <template #body>
        ...
        <Input size="sm" v-model="form.seccion" label="Nombre de Sección" :validationStatus="(form.errors.seccion?'error':'')">
